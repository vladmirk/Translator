package org.vk.translator.translation.vendor.translit;
...
@Component(Vendor.TRANSLIT)
public class TranslitVendor implements TranslatorVendor {
  ...
  public Translation translate(TranslationParam param) {
    return new SimpleTranslation(translit(param.getText()));
  }
}
